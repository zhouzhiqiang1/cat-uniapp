<template>
	<view>
		...
		<view class="guize" style="color: #666666;font-size: 25rpx;line-height: 2em;">1、有效用户定义；完成实名认证的直邀好友/扩散好友且猫等级达到8级；</view>
		<view class="guize" style="color: #666666;font-size: 25rpx;line-height: 2em;">2、有效用户定义；完成实名认证的直邀好友/扩散好友且猫等级达到8级；</view>
		<view class="guize" style="color: #666666;font-size: 25rpx;line-height: 2em;">3、有效用户定义；完成实名认证的直邀好友/扩散好友且猫等级达到8级；</view>
